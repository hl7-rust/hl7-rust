...
hl7-v2-xml-lite-helper
    |
    +-- hl7-v2-soap                          reads SOAP envelopes
    +-- hl7-v2-from-xml-into-er7             reads HL7 v2.xml messages
    +-- hl7-v2-from-xsd-into-json-dictionary reads HL7 v2.xml XSD schemas
```
...
- Before finishing a change, run:
  ```sh
  cargo test -p hl7-v2-xml-lite-helper
  cargo clippy -p hl7-v2-xml-lite-helper --all-targets -- -D warnings
  cargo fmt --check
  ```
- After any change, confirm the three callers still build against it:
  ```sh
  cargo build -p hl7-v2-soap -p hl7-v2-from-xml-into-er7 \
    -p hl7-v2-from-xsd-into-json-dictionary
  ```
