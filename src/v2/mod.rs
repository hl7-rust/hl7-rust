...
//!
//! ```
//! let message = hl7::v2::parse("MSH|^~\\&|LAB||EPIC||20240101||ORU^R01|1|P|2.5\r\
...
//!   "segments": { "ZPD": ["ST", "XPN"] }
//! }"#, "acme")?;
//! let options = hl7::v2::Options::new().with_dictionary(Arc::new(dictionary));
//! let message = hl7::v2::parse_with_options(
...
///
/// ```
/// let options = hl7::v2::Options::new()
///     .with_version(hl7::v2::Version::V2_3_1)  // ignore what MSH-12 says
