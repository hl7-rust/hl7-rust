...
//!
//! MLLP is how HL7 v2 usually moves, and `hl7-v2-mllp` is that transport.
...
//!
//! ```
//! use hl7_v2_soap::{Fault, message, response};
//!
...
//!     let envelope = hl7_v2_soap::parse(request_body)?;
...
//!
//! ```
//! use hl7_v2_soap::{message, response::{self, Outcome}};
//!
...
/// dependency.
///
/// `hl7-v2-xml-lite-helper` has no dependencies of its own, and is shared with the other
