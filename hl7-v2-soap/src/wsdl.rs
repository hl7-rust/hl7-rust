...
/// everyone.
pub const TARGET_NS: &str = "urn:hl7-v2-soap:service";
...
///
/// ```
/// let wsdl = hl7_v2_soap::wsdl::for_address("https://hub.example.nhs.uk/soap");
...
///
/// ```
/// let wsdl = hl7_v2_soap::wsdl::for_address_in(
