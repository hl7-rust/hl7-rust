# Specification: hl7-2-xml-lite-helper
...
`hl7-2-from-xml-into-er7` kept text and dropped attributes,
`hl7-2-from-xsd-into-json-dictionary` kept attributes and dropped text, and
`hl7-2-soap` kept text and dropped attributes again. Keeping all four
