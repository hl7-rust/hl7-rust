...
samples/*.xml          Example v2.xml input files, generated by running the
                       sibling hl7-v2-from-er7-into-xml crate — see below.
```
...
- **Regenerating samples**: `samples/*.xml` are the literal output of
  running the sibling `hl7-v2-from-er7-into-xml` crate against its own
  ...
  `cargo run --manifest-path ../hl7-v2-from-er7-into-xml/Cargo.toml -- <input.hl7>`
