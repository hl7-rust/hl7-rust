...
samples/*.xml          Example v2.xml input files, generated by running the
                       sibling hl7-2-5-to-xml-using-rust crate — see below.
```
...
- **Regenerating samples**: `samples/*.xml` are the literal output of
  running the sibling `hl7-2-5-to-xml-using-rust` crate against its own
  ...
  `cargo run --manifest-path ../hl7-2-5-to-xml-using-rust/Cargo.toml -- <input.hl7>`
