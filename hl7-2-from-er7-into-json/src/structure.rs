...
//! group names, same keys the sibling `hl7-2-from-er7-into-xml` crate
...
//! fit its grammar exactly (for example it contains Z-segments, or uses a
//! structure not defined here), the caller falls back to a flat segment
//! list under the root object.
