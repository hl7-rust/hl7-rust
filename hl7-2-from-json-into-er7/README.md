...
[Related crates](#related-crates) below.
...
(`er7::RenderOptions`, re-exported as `hl7_2_from_json_into_er7::er7::RenderOptions`),
...
`Result<_, hl7_2_from_json_into_er7::Hl7Error>`; an `Err` only ever means the input
...
| **`hl7-2-from-json-into-er7`** (this crate) | typed JSON → ER7 |
...
- [`hl7-2-from-er7-into-xml`](https://github.com/hl7-rust/hl7-rust/tree/main/hl7-2-from-er7-into-xml)
  and [`hl7-2-from-xml-into-er7`](https://github.com/hl7-rust/hl7-rust/tree/main/hl7-2-from-xml-into-er7)
