...
`hl7-2-from-xsd-into-json-dictionary` from a directory of XSDs — in place
...
`convert`/`convert_with_options` return `Result<String, hl7_2_from_er7_into_xml::Hl7Error>`;
...
| Crate | Direction |
|---|---|
| **`hl7-2-from-er7-into-xml`** (this crate) | ER7 → v2.xml XML |
...
Because [`hl7-2-from-xml-into-er7`](https://github.com/hl7-rust/hl7-rust/tree/main/hl7-2-from-xml-into-er7)
...
```sh
cargo run -- samples/orm_o01.hl7 \
  | cargo run -p hl7-2-from-xml-into-er7 --
```
...
- [`hl7-2-from-er7-into-json`](https://github.com/hl7-rust/hl7-rust/tree/main/hl7-2-from-er7-into-json) — this crate's JSON sibling
- [`hl7-2-from-xml-into-er7`](https://github.com/hl7-rust/hl7-rust/tree/main/hl7-2-from-xml-into-er7) — reads this crate's v2.xml output back into ER7
