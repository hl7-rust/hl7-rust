...
Anything about *what a segment or field means* belongs here. The four
conversion crates currently carry their own copies of the v2.5 data-type
tables and message structures; this crate's `schemas/v2.5.json` was
generated from those copies and is table-for-table identical to them, which
is what will let them depend on this crate rather than duplicate it.
