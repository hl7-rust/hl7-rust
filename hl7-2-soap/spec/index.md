...
XML is read by the `hl7-2-xml-lite-helper` crate, re-exported here as [`crate::xml`], and
...
needed the same subset and each had written it: `hl7-2-from-xml-into-er7`
kept text and dropped attributes, `hl7-2-from-xsd-into-json-dictionary`
kept attributes and dropped text, and this crate wanted text again. A reader
that keeps both replaced all three. `hl7-2-xml-lite-helper` has no dependencies of its
