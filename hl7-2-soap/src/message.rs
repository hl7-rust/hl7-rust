...
//! `hl7-2-from-xml-into-er7` and its sibling are for, and a transport
...
///
/// ```
/// let envelope = hl7_2_soap::message::wrap_er7("MSH|^~\\&|APP||||1||ADT^A01|9|P|2.5");
/// let parsed = hl7_2_soap::parse(&envelope)?;
/// let payload = parsed.payload()?;
/// assert_eq!(
///     hl7_2_soap::message::er7(payload),
